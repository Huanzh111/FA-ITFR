...
class AnomalyCLIP_PromptLearner(nn.Module):
    def __init__(self, clip_model, design_details):
        ...
        self.state_normal_list = [
            "perfectly pristine flawless perfect intact consistent uniform normal stable standard well ideal {}",
        ]
        self.state_anomaly_list = [
            "severely distorted flawed warped broken cracked uneven anomalous irregular aberrant unusual deformed damaged {}",
        ]
    ...
    def forward(self, cls_id=None):
        ...
        return prompts, tokenized_prompts, prompts_class, tokenized_prompts_class, self.compound_prompts_text